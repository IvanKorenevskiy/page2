...
module.exports = function (webpackEnv) {
  ...
  env.stringified['process.env'].servedPath = JSON.stringify(paths.servedPath);

  const getStyleLoaders = (cssOptions, preProcessor) => {
    const loaders = [
      isEnvDevelopment && require.resolve('style-loader'),
      isEnvProduction && {loader: MiniCssExtractPlugin.loader, options: shouldUseRelativeAssetPaths ? {publicPath: '../../'} : {}},
    ...
    if (preProcessor) {
      loaders.push({
        ...
        options: {sourceMap: isEnvDevelopment && shouldUseSourceMap}
      },
      {
